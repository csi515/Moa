...
import { getAdultStudentPortalGuide } from '../featureGuides';
...
/** 성인 수강생 포털 이용 안내 */
export const AdultStudentGuidePanel: FC<Props> = ({ industry }) => {
  const { intro, sections } = getAdultStudentPortalGuide(industry);
    ...
    <div className="bg-white rounded-2xl border border-slate-200 p-4 space-y-3">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0">
          <h3 className="text-sm font-black text-slate-900">{intro.title}</h3>

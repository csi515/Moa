...
const capabilitySrc = readSrc('src/core/commerce/storeCapability.ts');
...
const commerceFiles = walkTs(join(root, 'src/core/commerce'));
...
const barrel = readSrc('src/core/commerce/index.ts');

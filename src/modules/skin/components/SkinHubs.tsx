...
import { PilatesCustomerHubView } from '@/modules/pilates/components/PilatesCustomerHubView';
import { PilatesScheduleHubView } from '@/modules/pilates/components/PilatesScheduleHubView';

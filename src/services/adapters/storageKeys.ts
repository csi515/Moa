...
export const STORAGE_KEYS = {
  ...
  ACADEMY_HOMEWORK_ASSIGNMENTS: 'academy_homework_assignments',
  ACADEMY_HOMEWORK_CHECKS: 'academy_homework_checks',
  ACADEMY_EXAMS: 'academy_exams',
  ACADEMY_EXAM_SCORES: 'academy_exam_scores',
  PRODUCTS: 'core_products',
  PRODUCT_SALES: 'core_product_sales',
...
export const LOCAL_ONLY_KEYS: ReadonlySet<StorageKey> = new Set([
  ...
  STORAGE_KEYS.ACADEMY_HOMEWORK_ASSIGNMENTS,
  STORAGE_KEYS.ACADEMY_HOMEWORK_CHECKS,
  STORAGE_KEYS.ACADEMY_EXAMS,
  STORAGE_KEYS.ACADEMY_EXAM_SCORES,

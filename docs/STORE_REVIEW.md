...
```
Moa는 학원·체육관·어린이집 운영자와 학부모를 위한 B2B SaaS입니다.
...
**짧은 설명 (80자)**  
학원·체육관·어린이집 원생·출결·수납·학부모 포털 통합 관리

**전체 설명**  
Moa는 교육 기관 운영자와 학부모를 위한 올인원 관리 앱입니다. 원생 등록, 출결·키패드 체크인, 수납, 강사 관리, 학부모 포털, 알림장 등을 하나의 앱에서 이용할 수 있습니다.
